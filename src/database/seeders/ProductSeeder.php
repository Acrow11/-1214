    ...
    public function run()
    {
        ...
        $products = [
            [
                ...
                'image_path' => "storage/images/kiwi.jpg",
                'seasons' => [$autumn->id, $winter->id],
            ],
            [
                'name' => 'ストロベリー',
                'price' => 1200,
            ...
            [
                ...
                'image_path' => "images/muscat.jpg",
                'seasons' => [$summer->id, $autumn->id],
            ],
            [
                'name' => 'パイナップル',
                'price' => 800,
        ...
        foreach ($products as $productData) {
            ...
            $product->seasons()->attach($productData['seasons']);
        }
    }
}
